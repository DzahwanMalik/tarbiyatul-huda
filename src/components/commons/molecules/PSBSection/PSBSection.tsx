      ...
      <div className="p-5 bg-[var(--color-surface)] max-w-[var(--my-max-width)] m-auto lg:rounded-2xl lg:p-10 overflow-hidden">
        <div data-aos="fade-up">
          ...
          <p className="text-sm text-[var(--color-text-muted)] font-light mb-5">
            Penerimaan Santri Baru Tahun 2025-2026 telah dibuka! Saatnya
            bergabung bersama Pesantren Tarbiyatul Huda Bogor untuk menapaki
            jalan ilmu, iman, dan akhlak mulia menuju masa depan yang gemilang.
          </p>
